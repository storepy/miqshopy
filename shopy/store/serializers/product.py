...
# class _ProductListSerializer(ProductSerializerMixin, serializers.ModelSerializer):
#     class Meta:
#         model = Product
#         read_only_fields = (
#             'slug', 'name_truncated', 'category_data', 'cover_data', 'sizes',
...
# class ProductSerializer(_ProductListSerializer):
#     class Meta(_ProductListSerializer.Meta):
#         read_only_fields = (
#             *_ProductListSerializer.Meta.read_only_fields, 'sizes',
#             'images_data', 'attributes', 'stage_choices', 'created', 'updated',
#         )
#         fields = (
#             *read_only_fields,
