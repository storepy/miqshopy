...
import shopy.store.models.settingModel
import uuid
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('supplier', models.CharField(blank=True, choices=[('SHEIN', 'Shein'), ('PLT', 'Pretty Little Thing'), ('ASOS', 'Asos'), ('FNOVA', 'Fashion Nova')], max_length=50, null=True, verbose_name='Supplier')),
                ('supplier_item_id', models.CharField(blank=True, max_length=99, null=True, unique=True, verbose_name='Item identifier')),
                ('stage', models.CharField(choices=[('A_VIRTUAL', 'Virtual stock'), ('B_SUPPLIER_TRANSIT', 'Ordered from supplier'), ('C_INSTORE_WAREHOUSE', 'Received from supplier'), ('D_INSTORE_TRANSIT', 'In transit to store'), ('E_INSTORE', 'Available for purchase'), ('F_SOLDOUT', 'Sold Out')], default='A_VIRTUAL', max_length=30, verbose_name='Stage')),
                ('position', models.PositiveIntegerField(default=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cost', models.DecimalField(blank=True, decimal_places=2, help_text='FOB Price, excluding inbound shipping, taxes and others costs', max_digits=10, null=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currency', models.CharField(blank=True, choices=[('XOF', 'Franc CFA'), ('XAF', 'Franc CFA (BEAC)'), ('GHC', 'Ghanaian Cedi'), ('NGN', 'Nigerian Naira'), ('EUR', 'Euro'), ('USD', 'United States Dollar')], max_length=10, null=True, verbose_name='Currency')),
                ('supplier', models.CharField(choices=[('SHEIN', 'Shein'), ('PLT', 'Pretty Little Thing'), ('ASOS', 'Asos'), ('FNOVA', 'Fashion Nova')], default='SHEIN', max_length=50, verbose_name='Supplier')),
                ...
                ('products', models.ManyToManyField(blank=True, related_name='supplier_orders', through='store.SupplierItem', to='store.Product', verbose_name='Products')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='order',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='store.supplierorder', verbose_name='Order'),
        ),
        migrations.AddField(
            model_name='supplieritem',
            name='product',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='supplier_items', to='store.product', verbose_name='Product'),
        ),
        migrations.CreateModel(
            name='ShopSetting',
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='creation date and time')),
                ('updated', models.DateTimeField(auto_now=True, verbose_name='update date and time')),
                ('config', models.JSONField(default=shopy.store.models.settingModel.jsondef, verbose_name='Config')),
                ('currency', models.CharField(choices=[('XOF', 'Franc CFA'), ('XAF', 'Franc CFA (BEAC)'), ('GHC', 'Ghanaian Cedi'), ('NGN', 'Nigerian Naira'), ('EUR', 'Euro'), ('USD', 'United States Dollar')], default='XOF', max_length=10, verbose_name='Currency')),
                ...
                ('site', models.OneToOneField(blank=True, default=1, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='shopy', to='sites.site', verbose_name='Site')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='product',
            name='cover',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='store.productimage', verbose_name='Cover'),
        ),
        migrations.AddField(
            model_name='product',
            name='images',
        ...
        migrations.AddField(
            model_name='product',
            name='page',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='shopy_product', to='store.productpage'),
        ),
        migrations.AddField(
            model_name='category',
            name='page',
            field=models.OneToOneField(blank=True, on_delete=django.db.models.deletion.PROTECT, related_name='shopy_category', to='store.categorypage'),
        ),
